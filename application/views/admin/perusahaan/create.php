      ...
      <div class="card">
        <form action="<?= base_url(); ?>admin/perusahaan/tambah" action="post">
          <div class="card-body">
            <div class="row">
              <div class="col-2">
                <img src="" class="img-thumbnail img-preview" id="anggota-img" width="200" height="200">
              </div>
              <div class="col-10">
            ...
            <div class="form-group">
              ...
              <textarea name="alamat" id="alamat" cols="20" rows="2" class="form-control"></textarea>
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Industri</label>
              <input type="text" class="form-control" placeholder="Industri" name="industri">
            </div>
            <div class="form-group">
